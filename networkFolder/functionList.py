...
class WorldEstimatingNetwork():
    def __init__(self):
        ...
        self.network.load_state_dict(torch.load('networkFolder/class28x28reconstructionWeights', map_location={'cuda:0': 'mps'}))
...
class DigitClassificationNetwork():
    def __init__(self):
        ...
        self.network.load_state_dict(torch.load('networkFolder/class28x28classificationWeights', map_location={'cuda:0': 'mps'}))
